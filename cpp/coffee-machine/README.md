...
Проект — создание архитектуры на примере реализации автомата по приготовлению напитков (кофемашины). В этом проекте особое внимание уделено построению качественной архитектуры и использованию принципов ООП и SOLID.
